        ...
        return [
            ...
            { 
                ...
                childNodes: [
                    {
                        nodeName: '#text',
                        value: `window.$c = new c({ window, codec: '${this.ctx.config.codec || 'plain'}',  prefix: '${this.ctx.prefix}', ws: ${this.ctx.config.ws}, cookie: ${this.ctx.config.cookie}, title: ${typeof this.ctx.config.title == 'boolean' ? this.ctx.config.title : '\'' + this.ctx.config.title + '\''}, }); $c.init(); document.currentScript.remove();`
                    },
                ], 
                attrs: [],
            }
